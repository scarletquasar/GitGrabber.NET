...
using GitGrabber.StandaloneModels.Misc;
using System;
...
namespace GitGrabber.Social
{
    public class GithubRepository : IGithubRepository
    {
        ...
        public string ContribuitorsUrl { get; set; }
        ...
        public IEnumerable<IGithubCommit> GetCommits() => Connection.GetRepositoryCommits(Owner.Login, Name);
        public async Task<IEnumerable<IGithubCommit>> GetCommitsAsync() => await Connection.GetRepositoryCommitsAsync(Owner.Login, Name);
        public IGithubUser GetOwner() => Connection.GetUser(Owner.Login);
        public async Task<IGithubUser> GetOwnerAsync() => await Connection.GetUserAsync(Owner.Login);
    }
}
